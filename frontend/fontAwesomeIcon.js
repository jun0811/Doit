...
// 1. 아이콘 등록
import { faTimesCircle, faCheckCircle, faRssSquare, faUsers, faTimes, faCrown, faEllipsisH} from "@fortawesome/free-solid-svg-icons"; // fas로 시작하는것
import { faTrashAlt } from "@fortawesome/free-regular-svg-icons";
// 불러온 아이콘을 라이브러리에 담습니다.
library.add(faTrashAlt);
library.add( faEllipsisH, faTimesCircle, faCheckCircle, faRssSquare, faUsers, faTimes, faCrown);
